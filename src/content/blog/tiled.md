...
description: 'A deep dive into creating tile-based maps for game development, from asset preparation to layer management'
author: 'Nadja Rhodes'
tags: ['recurse', 'learning in public', 'gamedev']
---
...
### Texture Atlases vs Sprite Sheets
